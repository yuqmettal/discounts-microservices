...
(
 ...
 CONSTRAINT "PK_clients_prime_suscriptions" PRIMARY KEY ( "prime_suscription_id", "client_id" ),
...
(
 ...
 CONSTRAINT "PK_client_shopping_cars" PRIMARY KEY ( "shopping_car_id", "client_id" ),
...
(
 ...
 "category_id" int NOT NULL,
 CONSTRAINT "PK_stock_item" PRIMARY KEY ( "retailer_id", "product_id" ),
...
(
 ...
 "enabled"     boolean NOT NULL,
 "sector_id"   int NOT NULL,
 CONSTRAINT "PK_retailer_coverage_sectors" PRIMARY KEY ( "retailer_id", "sector_id" ),
...
(
 ...
 "retailer_id"      int NOT NULL,
 "product_id"       int NOT NULL,
 CONSTRAINT "PK_shopping_cart_items" PRIMARY KEY ( "retailer_id", "product_id", "shopping_car_id" ),
...
(
 ...
 CONSTRAINT "PK_order_items" PRIMARY KEY ( "order_id", "retailer_id", "product_id" ),
